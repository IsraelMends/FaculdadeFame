...
export function BannerFloat() {
    return (
        <BannerFloatContainer>
            <div className="flex flex-col items-center md:items-start gap-6 md:gap-8 px-4 sm:px-6 md:px-12 lg:px-20 py-10 md:py-16 lg:py-24 text-white rounded-2xl ">
                {/* Título */}
                ...
                <div className="w-full sm:w-10/12 md:w-8/12 lg:w-6/12">
                    <BannerFloatText className="text-sm sm:text-base md:text-lg leading-relaxed text-center md:text-left">
